            ...
            <div class="page-content-wrapper">
                <div class="page-content is-relative">
                    <div class="page-title has-text-centered">
                        ...
                        <a href="{{env('APP_URL')}}/su_admin/wdc" class="menu-toggle has-chevron">
                        ...
                        <div class="title-wrap">
                            <h1 class="title is-4">WDC - Detail Tim</h1>
                        </div>
                                                ...
                                                <div class="columns is-multiline">
                                                    ...
                                                    <div class="column is-12">
                                                        <div class="file-box">
                                                            ...
                                                            <div class="meta">
                                                                <span>Asal Institusi Pemimpin Tim</span>
                                                    ...
                                                    <div class="column is-12">
                                                        <div class="file-box">
                                                            ...
                                                            <div class="meta">
                                                                <span>Alamat Institusi Pemimpin Tim</span>
                                                    ...
                                                    @if(Auth::user()->user_type == 'staff')
                                                        <div class="column is-hidden-mobile">
                                                            <div class="buttons">
                                                                @if($data_team->status == '0')
                                                                    <a href="{{env('APP_URL')}}/su_admin/wdc/team/verifikasi/{{ $data_team->team_id }}" class="button h-button is-success is-rounded">
                                                                        <span class="icon">
                                                                ...
                                                                @elseif($data_team->status == '1')
                                                                    <a href="{{env('APP_URL')}}/su_admin/wdc/team/batal_verif/{{ $data_team->team_id }}" class="button h-button is-info is-rounded">
                                                                        <span class="icon">
                                                                ...
                                                                @if($data_team->status != 'bl')
                                                                    <a href="{{env('APP_URL')}}/su_admin/wdc/team/blacklist/{{ $data_team->team_id }}" class="button h-button is-danger is-rounded">
                                                                        <span class="icon">
                                                                ...
                                                                @else
                                                                    <a href="{{env('APP_URL')}}/su_admin/wdc/team/batal_bl/{{ $data_team->team_id }}" class="button h-button is-info is-rounded">
                                                                        <span class="icon">
                                                                            <i class="fas fa-ban"></i>
                                                                        </span>
                                                                ...
                                                                @endif
                                                                <a href="{{env('APP_URL')}}/su_admin/wdc/team/hapus/{{ $data_team->team_id }}" class="button h-button is-danger is-rounded">
                                                                    <span class="icon">
                                                                        <i class="fas fa-times"></i>
                                                                    </span>
                                                                    <span>Hapus</span>
                                                        ...
                                                        <div class="column is-12 is-hidden-table is-hidden-desktop">
                                                            <div class="buttons">
                                                                @if($data_team->status == '0')
                                                                    <a href="{{env('APP_URL')}}/su_admin/wdc/team/verifikasi/{{ $data_team->team_id }}" class="button h-button is-success is-rounded" style="width: 100%">
                                                                        <span class="icon">
                                                                            <i class="fas fa-check"></i>
                                                                        </span>
                                                                        <span>Verifikasi</span>
                                                                ...
                                                                @elseif($data_team->status == '1')
                                                                    <a href="{{env('APP_URL')}}/su_admin/wdc/team/batal_verif/{{ $data_team->team_id }}" class="button h-button is-info is-rounded" style="width: 100%">
                                                                        <span class="icon">
                                                                            <i class="fas fa-times"></i>
                                                                        </span>
                                                                        <span>Batal Verifikasi</span>
                                                        ...
                                                        <div class="column is-12 is-hidden-table is-hidden-desktop">
                                                            <div class="buttons">
                                                                @if($data_team->status != 'bl')
                                                                    <a href="{{env('APP_URL')}}/su_admin/wdc/team/blacklist/{{ $data_team->team_id }}" class="button h-button is-danger is-rounded" style="width: 100%">
                                                                        <span class="icon">
                                                                            <i class="fas fa-ban"></i>
                                                                        </span>
                                                                        <span>Blacklist</span>
                                                                ...
                                                                @else
                                                                    <a href="{{env('APP_URL')}}/su_admin/wdc/team/batal_bl/{{ $data_team->team_id }}" class="button h-button is-info is-rounded" style="width: 100%">
                                                                        <span class="icon">
                                                                            <i class="fas fa-ban"></i>
                                                                        </span>
                                                                        <span>Batal Blacklist</span>
                                                        ...
                                                        <div class="column is-12 is-hidden-table is-hidden-desktop">
                                                            <div class="buttons">
                                                                <a href="{{env('APP_URL')}}/su_admin/wdc/team/hapus/{{ $data_team->team_id }}" class="button h-button is-danger is-rounded" style="width: 100%">
                                                                    <span class="icon">
                                                                        <i class="fas fa-times"></i>
                                                                    </span>
                                                                    <span>Hapus</span>
                                        ...
                                        <div class="task-files">
                                            <div class="file-box">
                                                ...
                                                <div class="meta">
                                                    ...
                                                    <span>{{substr(filesize('storage/app/public/'.$dt_task->task_location.'/'.$dt_task->task_name)/1048576, 0, 5)}} MB</span>
                                                </div>
                                                <div class="dropdown is-spaced is-dots is-right dropdown-trigger end-action">
                                                    ...
                                                    <div class="dropdown-menu" role="menu">
                                                        <div class="dropdown-content">
                                                            <a href="{{ asset('storage/task_wdc/'.$dt_task->team_id.'/'.str_replace('#', '%23', $dt_task->task_name)) }}" class="dropdown-item is-media">
                                                                <div class="icon">
                                                            ...
                                                            <a href="{{ asset('storage/task_wdc/'.$dt_task->team_id.'/'.str_replace('#', '%23', $dt_task->task_name)) }}" target="_blank" class="dropdown-item is-media">
                                                                <div class="icon">
                                                            ...
                                                            <form action="{{env('APP_URL')}}/su_admin/wdc/team/{{$data_team->team_id}}/delete_task/{{ $dt_task->task_id }}" method="post" id="task_code_{{$dt_task->task_id}}">
                                                                @csrf
                                                                @method('DELETE')
                                                            </form>
                    ...
                    <div class="inner-content">
                        <div class="modal-form">
                            ...
                            <div class="field asal-ins">
                                ...
                                <div class="control">
                                    <input type="text" name="asal_ins" class="input" disabled>    
                                </div>
                            </div>
                            <div class="field alamat-ins">
                                <label>Alamat Institusi</label>
                                <div class="control">
                                    <textarea name="alamat_ins" class="textarea" disabled></textarea>    
                                </div>
                            </div>
                            <div class="field">
    ...
    <script>
        $(document).on("click", ".modal-member", function () {
            ...
            if(data_detail.nomor_id != null && data_detail.no_telpon != null){
                ...
                $('input[name="email"]').val(data_detail.email);
                $('input[name="asal_ins"]').val(data_detail.asal_ins);
                $('textarea[name="alamat_ins"]').val(data_detail.alamat_ins);
                $('input[name="tgl_lahir"]').val(data_detail.tgl_lahir);
