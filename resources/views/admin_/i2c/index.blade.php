                ...
                <div class="page-content is-relative">
                    ...
                    <div class="page-title has-text-centered">
                        ...
                        <div class="title-wrap">
                            <h1 class="title is-4">Innovative Informatics Contest (I2C)</h1>
                        </div>
                                        ...
                                        <div class="select-drop has-slimscroll-sm">
                                            <div class="drop-inner">
                                                <div class="option-row">
                                                    <form action="{{env('APP_URL')}}/su_admin/i2c" id="semua_team" method="get"></form>
                                                ...
                                                <div class="option-row">
                                                    <form action="{{env('APP_URL')}}/su_admin/i2c/1" id="verif_team" method="get"></form>
                                                ...
                                                <div class="option-row">
                                                    <form action="{{env('APP_URL')}}/su_admin/i2c/bl" id="bl_team" method="get"></form>
