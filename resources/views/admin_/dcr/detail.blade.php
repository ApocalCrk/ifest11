...
<x-layouts.app>
    ...
    <div id="ifst-app" class="app-wrapper">
        ...
        <div class="view-wrapper" data-naver-offset="214" data-menu-item="#dcr-sidebar-menu" data-mobile-item="#dcr-sidebar-menu-mobile">
            <div class="page-content-wrapper">
                <div class="page-content is-relative">
                    <div class="page-title has-text-centered">
                        
                        <a href="{{env('APP_URL')}}/su_admin/dcr" class="menu-toggle has-chevron">
                                                ...
                                                <div class="columns is-multiline">
                                                    ...
                                                    @if(Auth::user()->user_type == 'staff')
                                                        <div class="column is-hidden-mobile">
                                                            <div class="buttons">
                                                                @if($data_team->status == '0')
                                                                    <a href="{{env('APP_URL')}}/su_admin/dcr/team/verifikasi/{{ $data_team->team_id }}" class="button h-button is-success is-rounded">
                                                                        <span class="icon">
                                                                ...
                                                                @elseif($data_team->status == '1')
                                                                    <a href="{{env('APP_URL')}}/su_admin/dcr/team/batal_verif/{{ $data_team->team_id }}" class="button h-button is-info is-rounded">
                                                                        <span class="icon">
                                                                ...
                                                                @if($data_team->status != 'bl')
                                                                    <a href="{{env('APP_URL')}}/su_admin/dcr/team/blacklist/{{ $data_team->team_id }}" class="button h-button is-danger is-rounded">
                                                                        <span class="icon">
                                                                ...
                                                                @else
                                                                    <a href="{{env('APP_URL')}}/su_admin/dcr/team/batal_bl/{{ $data_team->team_id }}" class="button h-button is-info is-rounded">
                                                                        <span class="icon">
                                                                            <i class="fas fa-ban"></i>
                                                                        </span>
                                                                ...
                                                                @endif
                                                                <a href="{{env('APP_URL')}}/su_admin/dcr/team/hapus/{{ $data_team->team_id }}" class="button h-button is-danger is-rounded">
                                                                    <span class="icon">
                                                                        <i class="fas fa-times"></i>
                                                                    </span>
                                                                    <span>Hapus</span>
                                                        ...
                                                        <div class="column is-12 is-hidden-table is-hidden-desktop">
                                                            <div class="buttons">
                                                                @if($data_team->status == '0')
                                                                    <a href="{{env('APP_URL')}}/su_admin/dcr/team/verifikasi/{{ $data_team->team_id }}" class="button h-button is-success is-rounded" style="width: 100%">
                                                                        <span class="icon">
                                                                            <i class="fas fa-check"></i>
                                                                        </span>
                                                                        <span>Verifikasi</span>
                                                                ...
                                                                @elseif($data_team->status == '1')
                                                                    <a href="{{env('APP_URL')}}/su_admin/dcr/team/batal_verif/{{ $data_team->team_id }}" class="button h-button is-info is-rounded" style="width: 100%">
                                                                        <span class="icon">
                                                                            <i class="fas fa-times"></i>
                                                                        </span>
                                                                        <span>Batal Verifikasi</span>
                                                        ...
                                                        <div class="column is-12 is-hidden-table is-hidden-desktop">
                                                            <div class="buttons">
                                                                @if($data_team->status != 'bl')
                                                                    <a href="{{env('APP_URL')}}/su_admin/dcr/team/blacklist/{{ $data_team->team_id }}" class="button h-button is-danger is-rounded" style="width: 100%">
                                                                        <span class="icon">
                                                                            <i class="fas fa-ban"></i>
                                                                        </span>
                                                                        <span>Blacklist</span>
                                                                ...
                                                                @else
                                                                    <a href="{{env('APP_URL')}}/su_admin/dcr/team/batal_bl/{{ $data_team->team_id }}" class="button h-button is-info is-rounded" style="width: 100%">
                                                                        <span class="icon">
                                                                            <i class="fas fa-ban"></i>
                                                                        </span>
                                                                        <span>Batal Blacklist</span>
                                                        ...
                                                        <div class="column is-12 is-hidden-table is-hidden-desktop">
                                                            <div class="buttons">
                                                                <a href="{{env('APP_URL')}}/su_admin/dcr/team/hapus/{{ $data_team->team_id }}" class="button h-button is-danger is-rounded" style="width: 100%">
                                                                    <span class="icon">
                                                                        <i class="fas fa-times"></i>
                                                                    </span>
                                                                    <span>Hapus</span>
                                        ...
                                        <div class="task-files">
                                            <div class="file-box">
                                                ...
                                                <div class="dropdown is-spaced is-dots is-right dropdown-trigger end-action">
                                                    ...
                                                    <div class="dropdown-menu" role="menu">
                                                        <div class="dropdown-content">
                                                            <a href="{{ asset('storage/task_dcr/'.$dt_task->team_id.'/'.str_replace('#', '%23', $dt_task->task_name)) }}" class="dropdown-item is-media">
                                                                <div class="icon">
                                                            ...
                                                            <a href="{{ asset('storage/task_dcr/'.$dt_task->team_id.'/'.str_replace('#', '%23', $dt_task->task_name)) }}" target="_blank" class="dropdown-item is-media">
                                                                <div class="icon">
                                                            ...
                                                            <form action="{{env('APP_URL')}}/su_admin/dcr/team/{{$data_team->team_id}}/delete_task/{{ $dt_task->task_id }}" method="post" id="task_code_{{$dt_task->task_id}}">
                                                                @csrf
                                                                @method('DELETE')
                                                            </form>
